unit UDataModuleLeiaute;

interface

uses
  System.SysUtils, System.Classes, Vcl.ImgList, Vcl.Controls, cxGraphics,
  dxScreenTip, cxClasses, dxCustomHint, cxHint, cxStyles, cxGridTableView,
  ...
  dxSkinXmas2008Blue, cxLookAndFeels, dxSkinsForm, cxLocalization,
  dxSkinOffice2016Colorful, dxSkinOffice2016Dark, dxSkinVisualStudio2013Blue,
  dxSkinVisualStudio2013Dark, dxSkinVisualStudio2013Light, System.ImageList,
  cxGridBandedTableView, cxCustomPivotGrid, dxSkinOffice2019Colorful,
  dxSkinTheBezier, cxImageList, dxSkinBasic, dxSkinOffice2019Black,
  dxSkinOffice2019DarkGray, dxSkinOffice2019White, dxCore;

type
  TdmLeiaute = class(TDataModule)
    cxImageList16: TcxImageList;
    cxImageList32: TcxImageList;
    cxImageList128: TcxImageList;
  ...
  public
    { Public declarations }
    procedure DefineSkinPadrao(SkinName: TdxSkinName);
  end;

var
  dmLeiaute: TdmLeiaute;
...
procedure TdmLeiaute.DataModuleCreate(Sender: TObject);
var
   ALanguageFileName: TFileName;
begin
   cxLocalizer1.Active := False; {Destiva o componente / a tradução}
   ALanguageFileName := ExtractFilePath(Application.ExeName) +
                        'Languages\Portuguese-Br.ini';
   if FileExists(ALanguageFileName) then {Verifica se existe o arquivo dentro da pasta}
      begin
         cxLocalizer1.LoadFromFile(ALanguageFileName);
         cxLocalizer1.LanguageIndex := 1; {Muda o idioma / linguagem}
         cxLocalizer1.Active := True; {Ativa o componente / a tradução}
      end;
   DefineSkinPadrao('Stardust');
end;

procedure TdmLeiaute.DefineSkinPadrao(SkinName: TdxSkinName);
begin
